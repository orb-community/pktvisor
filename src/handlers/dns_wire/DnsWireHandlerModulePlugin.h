...
class DnsWireHandlerModulePlugin : public HandlerModulePlugin
{
...
public:
    explicit DnsWireHandlerModulePlugin(Corrade::PluginManager::AbstractManager &manager, const std::string &plugin)
