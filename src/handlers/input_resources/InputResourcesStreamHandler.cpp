...
void InputResourcesMetricsBucket::specialized_merge(const AbstractMetricsBucket &o, bool aggregate)
{
    ...
    _cpu_usage.merge(other._cpu_usage, aggregate);
    _memory_bytes.merge(other._memory_bytes, aggregate);
