...
public:
    ...
    std::unique_ptr<StreamHandler> instantiate(const std::string &name, InputCallback *input_stream_cb, Configurable *config, const Configurable *filter, StreamHandler *stream_handler = nullptr) override;
};
}
