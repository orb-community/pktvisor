...
void DnsMetricsBucket::specialized_merge(const AbstractMetricsBucket &o, bool aggregate)
{
    ...
    if (group_enabled(group::DnsMetrics::DnsTransactions)) {
        ...
        _dnsXactFromTimeUs.merge(other._dnsXactFromTimeUs, aggregate);
        _dnsXactToTimeUs.merge(other._dnsXactToTimeUs, aggregate);
        _dnsXactRatio.merge(other._dnsXactRatio, aggregate);
