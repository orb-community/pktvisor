...
TEST_CASE("DNS JSON Schema", "[dns][iface][json]")
{
    ...
    SECTION("json iface")
    {
        ...
        dns_xact_handler.config_set("recorded_stream", true);
        dns_xact_handler.config_set<visor::Configurable::StringList>("enable", visor::Configurable::StringList({"top_ecs"}));
        ...
        json dns_json;
        dns_xact_handler.metrics()->window_merged_json(dns_json, dns_xact_handler.schema_key(), 5);
