...
class DnsXactHandlerModulePlugin : public HandlerModulePlugin
{
...
public:
    explicit DnsXactHandlerModulePlugin(Corrade::PluginManager::AbstractManager &manager, const std::string &plugin)
